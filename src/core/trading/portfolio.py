...
class Portfolio:
        ...
        if symbol in self.positions:
            ...
            if new_quantity == 0:
                ...
                self.positions[symbol] = Position(
                    ...
                    entry_date=position.entry_date if new_quantity > 0 else datetime.now(),
                )
        else:
            # Create new position
            self.positions[symbol] = Position(
    ...
    def get_portfolio_metrics(self, current_prices: dict[str, float]) -> dict:
        ...
        return {
            ...
            "total_profit_loss_percent": (total_pl / self.initial_capital * 100) if self.initial_capital > 0 else 0,
            "positions": {
                symbol: {
                    ...
                    "profit_loss_percent": pos.profit_loss_percent(current_prices.get(symbol, 0)),
                }
